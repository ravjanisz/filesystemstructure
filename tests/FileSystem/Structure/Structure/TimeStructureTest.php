...
class TimeStructureTest extends TestCase {

    /** @var $obj TimeStructure */
    private $obj;

    protected function setUp():void {
        $structure = new TimeStructure();
    ...
    public function testNames() {
        ...
        $this->assertEquals('test3.txt', $response[4]->getName());
    }
    ...
    public function testOrderValue() {
        ...
        $this->assertEquals('assets/dir', $response[4]->getName());
    }
